...
while True:
    ...
    pygame.draw.rect(screen, (0,0,0), (0, 0, 70*8, 70*8), 2)
    x = 0
    ...
    if mouseclicked[0] == 1:
        ...
        if celly in range(8) and cellx in range(8):
            string = ["-" for _ in range(64)]
            ...
            movelist = []
            movelist = sidetestfile.path(finalstring)#path(string)
    ...
    goodperson = person(int(70 * goodpersonX), int(70 * goodpersonY))
    goodperson.createperson(col=(0, 255, 0))
    badperson = person(int(70*badpersonX),int(70*badpersonY))
